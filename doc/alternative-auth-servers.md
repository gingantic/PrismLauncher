...
> This list references by [ShatteredPrism's Alternative Auth Servers](https://github.com/Noctilune/ShatteredPrism/blob/develop/doc/alternative-auth-servers.md).
